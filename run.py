...
#parser.add_argument("--bs_dest", type=str, help="Filepath to folder for saving BandStructure objects")
...
def main():
    ...
    for i, mpid in enumerate(mpids):
        ...
        try:
            flatness_data = characterize_bands(mpid, api_key, fermi_windows, plot_window, img_dest=img_dest)
